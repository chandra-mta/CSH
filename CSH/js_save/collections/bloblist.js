...
//-------------------
	...
	fetch: function() {
        ...
        $.getJSON('https://cxc.cfa.harvard.edu/mta/CSH3/blob.json', function(data) {
...
app.monBlobList = new app.BlobList(null, {'baseURL': "https://cxc.cfa.harvard.edu/mta/CSH3/blob.json"});
app.scBlobList  = new app.BlobList(null, {'baseURL': "https://cxc.cfa.harvard.edu/mta/CSH3/blob.json"});
