...
app.BlobList = Backbone.Collection.extend({
    ...
    //
    // This one is now read a local JSON data file: blob_ccdm.json   (Apr 19, 2018, TI)
...
//-------------------
    ...
    // this one just read the local JSON data file (blob_ccdm.json), instead of reading bianry
	...
	fetch: function() {
        ...
        $.getJSON('/mta/CSH/blob_ccdm.json', function(data) {
...
app.monBlobList = new app.BlobList(null, {'baseURL': "/mta/CSH/blob_ccdm.json"});
app.scBlobList  = new app.BlobList(null, {'baseURL': "/mta/CSH/blob_ccdm.json"});
